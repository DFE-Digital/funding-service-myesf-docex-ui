...
namespace Pds.DocumentExchange.Web.Models.SupportTools
{
    ...
    /// </summary>
    public class DeleteDocumentsVersionSelect : DeleteDocuments
    {
        /// <inheritdoc/>
        ...
        /// <summary>
        /// Gets or sets the selected document version for delete.
        /// </summary>
        ...
        protected override string Title
            => "Select the version of the document to delete";
    }
}